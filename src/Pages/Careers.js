        ...
        <div style={{backgroundColor: '#F5F5F5'}}>
            <div style={{height: window.innerHeight}} className="homeBG">
                <div style={{paddingTop: 480}}>
                    ...
                    <p className={classes.guidance}>We at Smart Soft Studios offer a mix of growth prospects, advance learning, fair play and amazing work culture. Apply at careers@smartsoftstudios.com with the subject of job title.</p>
                    <Button
                        className="srvsBtn"
