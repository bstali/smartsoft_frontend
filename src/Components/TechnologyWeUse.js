...
export default function TechnologyWeUse() {
    ...
    return (
        <Grid container direction="row" justifyContent="center" alignItems="center" style={{paddingBottom: 100, paddingTop: 100}}>
            <Grid item xs={12}>
                <p className={classes.headingTop}>TECHNOLOGY WE USE</p>
            </Grid>
            <Grid item xs={1}></Grid>
            <Grid item xs={10}>
                <Carousel interval={3000} autoPlay={true} animation="slide" swipe={true} IndicatorIcon={false} navButtonsAlwaysInvisible={true}>
                    <Grid style={{paddingTop: 30}}>
                        ...
                        <Grid className={classes.imagesDisplay}>
                            ...
                            <img className={classes.img} src={ReactNative} alt="React Native" />
                            <img className={classes.img} src={Unity} alt="Unity3D" />
                            <img className={classes.img} src={Xcode} alt="Xcode" />
                            <img className={classes.img} src={AndroidStudio} alt="Android Studios" />
                            <img className={classes.img} src={CodeIgniter} alt="CodeIgniter" />
                        </Grid>
                    </Grid>
                    <Grid style={{paddingTop: 30}}>
                    ...
                    <Grid style={{paddingTop: 30}}>
                        ...
                        <img className={classes.img} src={AmazonWebServices} alt="AmazonWebServices" />
                    </Grid>
                    <Grid style={{paddingTop: 30}}>
                        <p className={classes.subHeading}>Digital Marketing</p>
                        <Grid className={classes.imagesDisplay}>
                            <img className={classes.img} src={GoogleAnalytics} alt="GoogleAnalytics" />
                            &nbsp; &nbsp; &nbsp;
